# DNS change plan — add `sattva.trilokventures.org` without breaking Google Workspace email

> **Scope:** Add exactly **one** hostname, `sattva`, to the Cloudflare-managed zone
> `trilokventures.org` so it serves the Sattva Odoo 18 web app over HTTPS — **without
